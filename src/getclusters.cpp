...
int main (int argc, char** argv)
{
	...
	float length_min = atof(argv[5]);  //1.5; // for a 2m height slice //2.25; //assuming 3m slice!!!
	float stepcov_max = atof(argv[6]);//0.2;
	float radratio_min =atof(argv[7]);// 0.8;
